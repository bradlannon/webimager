...
export function DownloadPanel() {
  const { sourceImage, transforms, adjustments, originalFile, cropRegion, backgroundRemoved, backgroundMask, replacementColor, bakedTexts } = useEditorStore();
  ...
  const handleDownload = (format: 'image/jpeg' | 'image/png') => {
    ...
    downloadImage(sourceImage, transforms, adjustments, format, quality, filename, cropRegion ?? undefined, backgroundRemoved ? backgroundMask : undefined, backgroundRemoved ? replacementColor : undefined, bakedTexts);
  };
